...
import com.rehan.quranapp.adapters.SurahAdapter;
import com.rehan.quranapp.common.Common;
import com.rehan.quranapp.databinding.ActivityMainBinding;
import com.rehan.quranapp.listener.SurahListener;
import com.rehan.quranapp.model.Surah;
import com.rehan.quranapp.viewmodel.SurahViewModel;
...
public class MainActivity extends AppCompatActivity implements SurahListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.rvSurah.setLayoutManager(new LinearLayoutManager(this));
    ...
    public void onSurahListener(int position) {
        //passing data from source activity to destination activity using intent
